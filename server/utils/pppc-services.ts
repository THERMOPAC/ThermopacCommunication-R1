...
export const PPPC_SEED_GROUPS: SeedGroup[] = [
  {
    ...
    subgroups: [
      ...
      { code: 'profiles',         label: 'Profiles',         sortOrder: 2 },
      { code: 'pipes',            label: 'Pipes',            sortOrder: 3 },
      { code: 'fittings',         label: 'Fittings',         sortOrder: 4 },
      { code: 'flanges',          label: 'Flanges',          sortOrder: 5 },
      { code: 'fasteners',        label: 'Fasteners',        sortOrder: 6 },
      { code: 'gaskets',          label: 'Gaskets',          sortOrder: 7 },
      { code: 'structural_steel', label: 'Structural Steel', sortOrder: 8 },
    ],
  },
  {
    ...
    subgroups: [
      ...
      { code: 'vacuum_pump',      label: 'Vacuum Pump',        sortOrder: 8 },
      { code: 'hand_pump',        label: 'Hand Pump',          sortOrder: 9 },
    ],
  },
  {
