...
/**
 * Special fix for generating inspection orders for Project 2025-3 (ID 5)
 * This handles decimal quantities and special cases for this specific project
 */
export const generateInspectionOrdersForProject5 = async (req: Request, res: Response) => {
  try {
    console.log('== SPECIAL FIX FOR PROJECT 5 (2025-3) - EXECUTION MODE ==');
    const projectId = 5; // Hard-coded project ID
    ...
    return res.status(200).json({
      success: true,
      message: `Created ${createdInspectionOrders.length} inspection orders successfully (SPECIAL FIX for 2025-3)`,
    ...
    console.error('Error in special fix for Project 5:', error);
