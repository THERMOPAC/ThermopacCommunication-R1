...
const DEFAULT_RULES: Array<{
  ...
  { workflowCode: 'BOM_approve',      stageGate: 'BOM', actionType: 'approve', department: 'Design',           role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Manager',       executionMode: 'manual', description: 'BOM — Approve Bill of Materials' },
  { workflowCode: 'BOM_release',      stageGate: 'BOM', actionType: 'release', department: 'Design',           role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Manager',       executionMode: 'manual', description: 'BOM — Release to production/procurement' },
  ...
  { workflowCode: 'DWG_approve',      stageGate: 'DWG', actionType: 'approve', department: 'Design',           role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Manager',       executionMode: 'manual', description: 'Drawing — Approve GA Drawing' },
  ...
  { workflowCode: 'PLN_approve',      stageGate: 'PLN', actionType: 'approve', department: 'Projects',         role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Senior Manager', executionMode: 'manual', description: 'Planning — Approve Execution Plan' },
  { workflowCode: 'PLN_release',      stageGate: 'PLN', actionType: 'release', department: 'Projects',         role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Senior Manager', executionMode: 'manual', description: 'Planning — Release execution plan (unblocks PO/WO)' },
  ...
  { workflowCode: 'PO_approve',       stageGate: 'PO',  actionType: 'approve', department: 'Purchase',         role: 'Manager',          fallbackDepartment: 'Purchase',     fallbackRole: 'Senior Manager', executionMode: 'manual', description: 'Purchase Order — Approve PO' },
  { workflowCode: 'PO_issue',         stageGate: 'PO',  actionType: 'issue',   department: 'Purchase',         role: 'Senior Manager',   fallbackDepartment: 'Purchase',     fallbackRole: 'Manager',       executionMode: 'manual', description: 'Purchase Order — Issue to vendor after approval' },
  ...
  { workflowCode: 'INS_verify',       stageGate: 'INS', actionType: 'verify',  department: 'Quality Control',  role: 'Manager',          fallbackDepartment: 'Quality Control', fallbackRole: 'Senior Manager', executionMode: 'manual', description: 'Inspection — Verify / Pass or Fail Inspection' },
  { workflowCode: 'DSP_prepare',      stageGate: 'DSP', actionType: 'prepare', department: 'Stores',           role: 'Senior Executive', fallbackDepartment: 'Projects',     fallbackRole: 'Manager',       executionMode: 'auto',   description: 'Dispatch — Prepare Dispatch Readiness (auto-created on INS pass)' },
  { workflowCode: 'DSP_confirm',      stageGate: 'DSP', actionType: 'confirm', department: 'Projects',         role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Senior Manager', executionMode: 'manual', description: 'Dispatch — Confirm Delivery Complete' },
  { workflowCode: 'COM_execute',      stageGate: 'COM', actionType: 'execute', department: 'After Sales',      role: 'Senior Executive', fallbackDepartment: 'After Sales',  fallbackRole: 'Manager',       executionMode: 'manual', description: 'Commissioning — Execute Site Commissioning' },
  ...
  { workflowCode: 'kickoff_pm',       stageGate: 'PLN', actionType: 'prepare', department: 'Projects',         role: 'Manager',          fallbackDepartment: 'Projects',     fallbackRole: 'Senior Manager', executionMode: 'auto',   description: 'Kickoff — Project Plan & Schedule (PM) auto-assigned on conversion' },
...
export async function seedEpcAssignmentRules(adminUserId?: number): Promise<void> {
  const existing = await db.execute(sql`SELECT COUNT(*) as cnt FROM epc_assignment_rules`);
