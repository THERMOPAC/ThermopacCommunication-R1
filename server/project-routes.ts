    ...
    try {
      ...
      const parseSapBpRow = (bp: any): BPRow => {
        ...
        return {
          ...
          BillAddrLine1:    sapAddr(billEntry?.Address2),
          BillAddrLine2:    sapAddr(billEntry?.Address3),
          BillAddrBlock:    sapAddr(billEntry?.Block),
          BillAddrBuilding: sapAddr(billEntry?.Building),
          BillAddrCity:     sapAddr(billEntry?.City),
          ShipAddrLine1:    sapAddr(shipEntry?.Address2),
          ShipAddrLine2:    sapAddr(shipEntry?.Address3),
          ShipAddrBlock:    sapAddr(shipEntry?.Block),
          ShipAddrBuilding: sapAddr(shipEntry?.Building),
