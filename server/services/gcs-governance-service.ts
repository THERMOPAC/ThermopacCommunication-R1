...
const SEED_RULES = [
  ...
  { moduleKey: 'epc', submoduleKey: 'co',           documentType: 'CO_DOCUMENT',     displayName: 'Customer Order Document',     rootPrefix: 'TPEL', pathTemplate: 'TPEL/{CC}/{CO}/{Cust}/{FY}/{NNN}/CO/{CO}/{Seq}-{Label}-rev-{rev}.{ext}',                    revisionMode: 'numeric',   notes: 'customer-order-document-routes.ts. Revision is filename suffix (2026-05).' },
