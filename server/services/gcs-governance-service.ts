...
const SEED_RULES = [
  ...
  { moduleKey: 'qms', submoduleKey: 'calibration',  documentType: 'CALIBRATION_CERT',displayName: 'Calibration Certificate',     rootPrefix: 'QMS', pathTemplate: 'QMS/Instrument/{filename}',                                                                 revisionMode: 'none',      notes: 'TRANSITIONAL ROOT — Family B (company-level). calibration-routes.ts. Flat file, no revision folder. Company-owned instruments calibrated periodically. Family B target: TPEL/QMS/{CompanyFY}/CALIBRATION/{filename}' },
