...
const SEED_RULES = [
  ...
  { moduleKey: 'epc', submoduleKey: 'quotation',     documentType: 'QUOTATION',     displayName: 'Standalone Offer PDF (pre-project)',  rootPrefix: 'TPEL', pathTemplate: 'TPEL/{CC}/{CO}/{Cust}/{FY}/Quotations/{OfferNo}/rev-{rev}/{Seq}-{Label}.pdf',       revisionMode: 'numeric',   notes: 'buildQuotationGcsPath() in epc-coding.ts — standalone offer PDF, no project NNN. FY=current FY at time of generation. Corrected 2026-05: token was {filename}, now {OfferNo}.' },
  { moduleKey: 'epc', submoduleKey: 'epc_quotation', documentType: 'EPC_QUOTATION', displayName: 'Project-Linked Quotation (EPC)',       rootPrefix: 'TPEL', pathTemplate: 'TPEL/{CC}/{CO}/{Cust}/{FY}/{NNN}/QTN/{OfferNo}/rev-na/{Seq}-{Label}.pdf',           revisionMode: 'none',      notes: 'buildEpcQtnGcsPath() in epc-coding.ts — project-linked quotation copy, always rev-na. Stores to epc_document_attachments. Added 2026-05.' },
  // DVS
