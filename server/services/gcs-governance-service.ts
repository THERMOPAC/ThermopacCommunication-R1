...
const SEED_RULES = [
  ...
  { moduleKey: 'admin', submoduleKey: 'business_trip',documentType: 'TRIP_DOCUMENT',  displayName: 'Business Trip Document',       rootPrefix: 'TPEL/ADMIN/HR', pathTemplate: 'TPEL/ADMIN/HR/{CompanyFY}/TRIPS/{EmployeeName}/{Destination}/{DocType}/{filename}', revisionMode: 'none',       notes: 'Family B — company admin. trip-management-routes.ts. Target path set 2026-05 (Option C). Existing files: Business_Trips/{BizYear}/{EmployeeName}/{Destination}/{FromDate}/{DocType}/... — migration pending.' },
  { moduleKey: 'admin', submoduleKey: 'visa',         documentType: 'VISA_DOCUMENT',   displayName: 'Visa / Travel Document',       rootPrefix: 'TPEL/ADMIN/HR', pathTemplate: 'TPEL/ADMIN/HR/{CompanyFY}/VISA/{EmployeeName}/{Category}/{filename}',              revisionMode: 'none',       notes: 'Family B — company admin. visa-management-routes.ts. Target path set 2026-05 (Option C). Existing files: Visa_Documents/{EmployeeName}/{Category}/... — migration pending.' },
