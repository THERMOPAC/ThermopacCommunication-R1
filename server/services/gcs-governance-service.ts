...
const SEED_RULES = [
  ...
  { moduleKey: 'sales', submoduleKey: 'customer_order', documentType: 'CUSTOMER_ORDER', displayName: 'Customer Order (Standalone)',     rootPrefix: 'TPEL', pathTemplate: 'TPEL/{CC}/{CO}/{Cust}/{FY}/Open_Orders/{OfferNo}/{Seq}-{Subject}-rev-{rev}.pdf',            revisionMode: 'numeric',   notes: 'Standalone Offer → Order confirmation document. No project NNN. Mirrors Open_Quotations structure. 2026-05.' },
  { moduleKey: 'sales', submoduleKey: 'sales_contract', documentType: 'SALES_CONTRACT', displayName: 'Sales Contract (Project-Linked)', rootPrefix: 'TPEL', pathTemplate: 'TPEL/{CC}/{CO}/{Cust}/{FY}/{NNN}/Contracts/{OfferNo}/{Seq}-{Subject}-rev-{rev}.pdf',       revisionMode: 'numeric',   notes: 'Project-Linked Quotation → Sales Contract. Scoped under project NNN/Contracts. 2026-05.' },
  // DVS
