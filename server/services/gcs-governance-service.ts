...
const SEED_RULES = [
  ...
  { moduleKey: 'qms', submoduleKey: 'material_id',  documentType: 'MATERIAL_CERT',   displayName: 'Material Identification Doc', rootPrefix: 'QMS', pathTemplate: 'QMS/Material_Identification/{ProjectCode}/{Seq}/{filename}',                                revisionMode: 'none',      notes: 'TRANSITIONAL ROOT — Family A (project-specific). material-identification-routes.ts. Linked to project via project_id FK. Family A target: TPEL/{CC}/{CO}/{Cust}/{ProjectFY}/{NNN}/QMS/MATERIAL-ID/{Seq}/{filename}' },
  ...
  { moduleKey: 'design', submoduleKey: 'drawings',   documentType: 'DESIGN_DRAWING',  displayName: 'Design Drawing (governed)',    rootPrefix: 'TPEL', pathTemplate: 'TPEL/{CC}/{CO}/{Cust}/{FY}/{NNN}/{ItemCode}/DWG/{DrawingNo}_rev-{rev}.{ext}',               revisionMode: 'alphabetic', notes: 'design-drawing-routes.ts — uses buildDrawingGcsPath. Family A.' },
