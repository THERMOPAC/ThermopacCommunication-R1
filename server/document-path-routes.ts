...
const GCS_MIRROR_SEEDS: Array<{
  ...
  { templateCode: 'CO_DOCUMENT',     documentType: 'CO_DOCUMENT',     documentCategory: 'EPC',     relativePathTemplate: '{COMPANY}/{CC}/{CO}/{Cust}/{FY}/{NNN}/Sales/Order_Contract/{Seq}-{Label}-rev-{rev}.pdf', revisionMode: 'suffix',   active: true  },
