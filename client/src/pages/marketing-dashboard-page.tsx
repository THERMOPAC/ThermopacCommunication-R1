                  ...
                  <div className="flex flex-col space-y-1">
                    ...
                    <div className="grid grid-cols-1 text-xs gap-1">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium text-right w-24">₹{formatINRInCrores(financeData?.totalInvoices?.amount ? parseFloat(financeData.totalInvoices.amount) * 85.413325 : 0)} Cr</span>
                      </div>
                    </div>
                  </div>
                  <Button 
