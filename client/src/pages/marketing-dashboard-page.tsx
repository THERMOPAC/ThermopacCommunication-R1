            ...
            <CardContent>
              {isLoadingOrders ? (
                ...
                <div>
                  <div className="mb-1">
                    <div className="text-2xl font-bold">
                      {ordersData?.count || 0} active orders
                    </div>
                  </div>
                  <div className="text-lg font-bold flex flex-col gap-0 text-right">
                    {ordersData?.valuesByCurrency && Object.keys(ordersData.valuesByCurrency).length > 0 ? (
                      Object.entries(ordersData.valuesByCurrency).map(([currency, value]) => (
                        <span key={currency}>
                  ...
                  <div className="text-sm font-medium mt-1 text-green-600 text-right">
                    ~INR {ordersData?.totalValueINR && ordersData.totalValueINR > 0 ? 
                      formatINRInCrores(ordersData.totalValueINR) : 
                      '0.00 Cr'}
                  </div>
                </div>
              )}
