...
export default function EpcBuyListControlPage() {
  ...
  function submitLine() {
    ...
    const isSpecBasedItem  = isMotorSpecBased || currentSubgroupCode === 'isolation' || currentSubgroupCode === 'control' || currentSubgroupCode === 'safety' || currentSubgroupCode === 'on_off';
