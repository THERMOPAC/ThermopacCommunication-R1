                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="text-[10px] w-[175px] px-2">Item</TableHead>
                        <TableHead className="text-[10px] w-[190px] px-2">Product Identity</TableHead>
                          ...
                          <TooltipProvider key={rec.id}>
                            <TableRow className={`cursor-pointer hover:bg-muted/30 ${isExpanded ? "bg-muted/20" : ""} ${!rec.is_current ? "opacity-60" : ""}`} onClick={() => setExpandedId(isExpanded ? null : rec.id)}>
                              ...
                              <TableCell className="text-[10px] py-1 px-2">
                                <div className="truncate max-w-[170px]" title={rec.item_description || ""}>{rec.item_code}</div>
                              </TableCell>
                              <TableCell className="text-[10px] py-1 px-2">
                                {(() => {
                                  const identity = [rec.product_p1_label, rec.product_p2_label, rec.product_p3].filter(Boolean).join(' ');
                                  return identity
                                    ? <div className="truncate max-w-[185px] text-blue-600" title={identity}>{identity}</div>
