...
import {
  ...
  Unlock, RotateCcw, ArrowUpDown, ChevronDown, ChevronRight,
...
const LIFECYCLE_ACTIONS: ActionDef[] = [
  ...
  { key: "review", label: "Review", icon: Eye, variant: "default", minRoleLevel: 3, statusRequired: ["under_review"], needsNote: true, noteLabel: "Review Note", noteKey: "reviewNote", extraCheck: (r) => !r.reviewed_at },
