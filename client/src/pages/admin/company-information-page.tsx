...
const DOC_TYPES = ['GST_CERTIFICATE','PAN_CARD','IEC_CERTIFICATE','LUT_COPY','MSME_CERTIFICATE',
  'CANCELLED_CHEQUE_BOB','CANCELLED_CHEQUE_ICICI',
  'LEI_CERTIFICATE','RCMC_CERTIFICATE','PT_REGISTRATION','TAN_CERTIFICATE',
  'SHOP_ESTABLISHMENT_CERTIFICATE','SSI_UDYAM_REGISTRATION','MPCB_CTO',
  'ESIC_CERTIFICATE','INCORPORATION_CERTIFICATE','FACTORY_DEED_OF_ASSIGNMENT_TRANSFER','FACTORY_LICENSE','PF_ESI_DOCUMENT'];
...
const MANDATORY_DOCS = ['GST_CERTIFICATE','PAN_CARD','CANCELLED_CHEQUE_BOB','CANCELLED_CHEQUE_ICICI',
  'LEI_CERTIFICATE','RCMC_CERTIFICATE','PT_REGISTRATION','TAN_CERTIFICATE',
  'SHOP_ESTABLISHMENT_CERTIFICATE','SSI_UDYAM_REGISTRATION','MPCB_CTO','ESIC_CERTIFICATE','INCORPORATION_CERTIFICATE'];
