          ...
          <section className="rounded border border-slate-200 bg-white">
            ...
            {currentGeometry ? <div className="p-3">
              ...
              {view === "ga" ? currentGaSvg ? <div data-testid="stage5-current-ga">
                <p className="mb-2 text-xs font-semibold text-cyan-900">CURRENT SYSTEM GENERAL ARRANGEMENT · NOT TO SCALE. Each end independently shows calculated numeric results or system model/source HOLD. Symbolic profiles are not fabrication geometry. Frozen active geometry is unchanged.</p>
