  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { icon: BookMarked,    label: "Lessons Learned",      href: "/oi/lessons" },
    ...
    ...(hasViewPermission("Project Management") ? [{ 
      ...
      children: [
        ...
        ...(hasPageAccess("work-orders") ? [{ icon: Wrench, label: "Work Orders", href: "/epc/work-orders" }] : []),
        ...(hasPageAccess("quality-inspection") ? [{ icon: ShieldCheck, label: "Quality & Inspection", href: "/epc/quality-inspection" }] : []),
        ...(hasPageAccess("invoices") ? [{ icon: Receipt, label: "Invoices", href: "/epc/invoices" }] : []),
        ...(hasPageAccess("dispatch-logistics") ? [{ icon: Truck, label: "Dispatch & Logistics", href: "/epc/dispatch-logistics" }] : []),
        ...(hasPageAccess("commissioning-handover") ? [{ icon: Wrench, label: "Commissioning & Handover", href: "/epc/commissioning-handover" }] : []),
    ...
    { icon: CalendarDays, label: "Leave Request", href: "/leave-request" },
    { icon: Star, label: "Appraisals", href: "/appraisals" },
