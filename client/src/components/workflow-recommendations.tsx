                ...
                <div className="bg-muted p-4 rounded-md text-sm">
                  {recommendation.recommendationType === 'task_assignment' && recommendation.recommendationData && (
                    <div className="space-y-2">
                      <p><strong>Your current tasks:</strong> {typeof recommendation.recommendationData === 'object' && 'taskCount' in recommendation.recommendationData ? String(recommendation.recommendationData.taskCount) : 'N/A'}</p>
                      <p><strong>Recommended assignee:</strong> {typeof recommendation.recommendationData === 'object' && 'recommendedAssigneeName' in recommendation.recommendationData ? String(recommendation.recommendationData.recommendedAssigneeName) : 'N/A'}</p>
                      <p><strong>Their current tasks:</strong> {typeof recommendation.recommendationData === 'object' && 'recommendedAssigneeTaskCount' in recommendation.recommendationData ? String(recommendation.recommendationData.recommendedAssigneeTaskCount) : 'N/A'}</p>
                    </div>
                  )}
                  
                  {recommendation.recommendationType === 'priority_adjustment' && recommendation.recommendationData && (
                    <div className="space-y-2">
                      <p><strong>Task:</strong> {typeof recommendation.recommendationData === 'object' && 'taskTitle' in recommendation.recommendationData ? String(recommendation.recommendationData.taskTitle) : 'N/A'}</p>
                      <p><strong>Current priority:</strong> {typeof recommendation.recommendationData === 'object' && 'currentPriority' in recommendation.recommendationData ? String(recommendation.recommendationData.currentPriority) : 'N/A'}</p>
                      <p><strong>Due date:</strong> {typeof recommendation.recommendationData === 'object' && 'dueDate' in recommendation.recommendationData ? String(recommendation.recommendationData.dueDate) : 'N/A'}</p>
                      <p><strong>Days until due:</strong> {typeof recommendation.recommendationData === 'object' && 'daysUntilDue' in recommendation.recommendationData ? String(recommendation.recommendationData.daysUntilDue) : 'N/A'}</p>
                    </div>
                  )}
                  ...
                  {recommendation.recommendationType === 'follow_up' && recommendation.recommendationData && (
                    <div className="space-y-2">
                      <p><strong>Task:</strong> {typeof recommendation.recommendationData === 'object' && 'taskTitle' in recommendation.recommendationData ? String(recommendation.recommendationData.taskTitle) : 'N/A'}</p>
                      <p><strong>Assigned to:</strong> {typeof recommendation.recommendationData === 'object' && 'assigneeName' in recommendation.recommendationData ? String(recommendation.recommendationData.assigneeName) : 'N/A'}</p>
                      <p><strong>Due date:</strong> {typeof recommendation.recommendationData === 'object' && 'dueDate' in recommendation.recommendationData ? String(recommendation.recommendationData.dueDate) : 'N/A'}</p>
                      <p><strong>Days overdue:</strong> {typeof recommendation.recommendationData === 'object' && 'daysOverdue' in recommendation.recommendationData ? String(recommendation.recommendationData.daysOverdue) : 'N/A'}</p>
                    </div>
                  )}

                  {recommendation.recommendationType === 'team_collaboration' && recommendation.recommendationData && (
                    <div className="space-y-2">
                      <p><strong>Team members:</strong> {typeof recommendation.recommendationData === 'object' && 'teamMembers' in recommendation.recommendationData ? String(recommendation.recommendationData.teamMembers) : 'N/A'}</p>
                      <p><strong>Tasks with similar categories:</strong> {typeof recommendation.recommendationData === 'object' && 'similarTaskCount' in recommendation.recommendationData ? String(recommendation.recommendationData.similarTaskCount) : 'N/A'}</p>
                    </div>
                  )}
                  
                  {recommendation.recommendationType === 'deadline_reminder' && recommendation.recommendationData && (
                    <div className="space-y-2">
                      <p><strong>Upcoming deadlines:</strong> {typeof recommendation.recommendationData === 'object' && 'upcomingDeadlinesCount' in recommendation.recommendationData ? String(recommendation.recommendationData.upcomingDeadlinesCount) : 'N/A'}</p>
                      <p><strong>Next deadline:</strong> {typeof recommendation.recommendationData === 'object' && 'nextDeadline' in recommendation.recommendationData ? String(recommendation.recommendationData.nextDeadline) : 'N/A'}</p>
                    </div>
                  )}
                </div>
              </AccordionContent>
