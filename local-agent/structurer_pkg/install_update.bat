@echo off
REM ============================================================
REM  Thermopac Drawing Structuring Agent v1.0.15
...
title ThermopacStructurer Updater v1.0.15
...
echo.
echo  Thermopac Drawing Structuring Agent — Update to v1.0.15
echo  --------------------------------------------------------
echo  Source : %SRC%
...
echo  ============================================================
echo   Update complete!  ThermopacStructuringAgent is now v1.0.15
echo  ============================================================
echo.
