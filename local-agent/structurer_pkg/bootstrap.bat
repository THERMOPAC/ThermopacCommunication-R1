...
echo.
echo  =========================================================
echo   Thermopac Drawing Structuring Agent  v1.0.3
...
(
    echo @echo off
    echo title ThermopacStructurer v1.0.3 - THERMOPAC ERP
...
powershell -Command ^
  "$s = (New-Object -COM WScript.Shell).CreateShortcut('%SHORTCUT_PATH%'); $s.TargetPath = '%SHORTCUT_TARGET%'; $s.WorkingDirectory = '%AGENT_DIR%'; $s.Description = 'Thermopac Drawing Structuring Agent v1.0.3'; $s.Save()"
