              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  Trigger>
                    ...
                    readOnly
                    disabled
                  Value placeholder="Select certificate type" />
                    </SelectTrigger>
                    <Input
                    id="certificateType"
                    name="certificateType"
                  ...
                  Content>
                    ...
                    readOnly
                    disabled
                  Item value="WELDER_QUALIFICATION">
                  ...
                  Item value="SPECIALIZED_SKILL">
                    ...
                    readOnly
                    disabled
                  Item value="OTHER">Other</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
