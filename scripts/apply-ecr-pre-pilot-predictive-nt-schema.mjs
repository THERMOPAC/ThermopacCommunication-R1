...
const migrationPaths = [
  ...
  'migrations/ecr_pre_pilot_stage4_physical_sizing_calculations.sql',
  'migrations/ecr_pre_pilot_stage5_geometry_revisions.sql',
  'migrations/ecr_pre_pilot_stage5_end_sections.sql',
