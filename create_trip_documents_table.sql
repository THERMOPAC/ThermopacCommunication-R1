...
CREATE TABLE trip_documents (
    ...
    file_path TEXT NOT NULL, -- GCS path: Business_Trips/{FinancialYear}/{EmployeeName}/{Destination}/{FromDate}/{DocumentType}/filename
...
COMMENT ON COLUMN trip_documents.file_path IS 'Structured GCS path: Business_Trips/{FinancialYear}/{EmployeeName}/{Destination}/{FromDate}/{DocumentType}/filename';
