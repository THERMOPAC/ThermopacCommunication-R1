...
- **Key Modules & Features**:
    ...
    - **Sales & Marketing**: AI-powered lead generation, product database, offer/quotation module, Google Ads integration, and Commercial Change Order (CCO) control linking Sales and EPC with sequential ordering, approval gates, ECR linkage, and computed financial traceability.
