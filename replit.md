...
- **Multi-Agent Intelligence & Automation Layer**: An intelligence layer with agents for Project Control, Communications, Finance Control, Executive MIS, and Sales & Marketing. Features include conflict control, event bus, finding management with deduplication, insight/recommendation management with policy-based approval, and an audit logger. Agents operate in an observe-only capacity in Phase 1.
