...
OUT=ROOT/"research-results/finite-film-sparse-collocation-v10-test-v5.json"
SNAP=ROOT/"research-results/source-snapshots/finite-film-sparse-v10-test-v2"
...
def run():
    ...
    report={"schemaVersion":"SPARSE_COLLOCATION_V10_TEST_ONLY_V5",
