...
OUT=ROOT/"research-results/finite-film-cell1-sparse-v10-terminal.json"
SNAP=ROOT/"research-results/source-snapshots/finite-film-sparse-v10-real"
    ...
    try:
        ...
        try:
            ...
            first,root1=branch(first_branch,warm["interfaceContinuous"],
              warm["interfaceDispersed"],warm["flux"],warm_pc,warm_pd)
