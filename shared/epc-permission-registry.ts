...
export const EPC_GAPS: GapFinding[] = [
  {
    ...
    affectedRoles: [4, 5],
    recommendation: "Apply the same userLevel > Manager restriction to invoice and billing amount columns on their dedicated pages.",
  ...
  },
  {
    ...
    fixApplied: "Backend PATCH /api/commissioning-readiness/:id now checks if any checklist fields are being updated and rejects with 403 if roleHierarchy[userRole] > roleHierarchy['Manager'] (Senior Executive and Employee).",
  },
  {
...
export const ROLE_LEVELS = [0, 1, 2, 3, 4, 5] as const;
